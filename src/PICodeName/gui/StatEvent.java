 ...
 * @author farou
 */
public class StatEvent extends Form {
    ...
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Integer> a) {
        ...
        for (int i = 0; i < a.size(); i=i+2) {
            series.add("Month "+a.get(i), a.get(i+1));
        }

        return series;
    }

    public StatEvent(Form previous) {
        ...
        a = ServiceEvent.getInstance().getstat();
        ...
        renderer.setChartTitle("Stat Month");
